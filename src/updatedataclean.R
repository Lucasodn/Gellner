...
# Change the Turner variables to integers, since they were characters.
...
# assume missing values are 0. so no value for a region means there were no turnvereine
...
# The Data set of Hornung with which we merged the Turner misses 6 kreiskeys. 
...
# two kreiskey has an NA a the city level but not the kreis level, so we set it 
...
edu1864 <- read.csv("../data/Data Proxy Industrializtaion/Education/ipehd_1864_edu_stud.csv") %>%
  transmute(kreiskey1864,
            county,
            students1864 = edu1864_pub_ele_stud + 
              edu1864_pub_mim_stud_m +
              edu1864_pub_mif_stud_f +
              edu1864_pub_rea_stud +
              edu1864_pub_pgy_stud +
              edu1864_pub_gym_stud +
              edu1864_pub_sem_par +
              edu1864_pri_ele_stud +
              edu1864_pri_hsm_stud_m +
              edu1864_pri_hsf_stud_f +
              edu1864_pri_voc_stud +
              edu1864_pri_sun_stud) %>%
...
steamengines <- read.csv("../data/Data Proxy Industrializtaion/Industrialization/1849_indu_tec.csv",
  ...
  transmute(kreiskey1849, 
            steamengines1849 = mill1849_steam_grindingstones +
              steam1849_spinnery_engines +
              steam1849_spinnery_horsepower +
              steam1849_weaving_engines +
              steam1849_weaving_horsepower +
              steam1849_fulling_engines +
              steam1849_fulling_horsepower +
              steam1849_engineworks_engines +
              steam1849_engineworks_horsepower +
              steam1849_flourmill_engines +
              steam1849_flourmill_horsepower +
              steam1849_cuttingmill_engines +
              steam1849_cuttingmill_horsepower +
              steam1849_othermills_engines +
              steam1849_othermills_horsepower +
              steam1849_mining_engines +
              steam1849_mining_horsepower +
              steam1849_shipping_engines +
              steam1849_shipping_horsepower +
              steam1849_metal_fab_engines +
              steam1849_metal_fab_horsepower +
...
# Reading in serv1849 in 1849, since its the highest share of occupational class
...
edu1849 <- read.csv("../data/Data Proxy Industrializtaion/Education/ipehd_1849_edu_stud.csv") %>%
  transmute(kreiskey1849,
            students1849 = edu1849_pub_ele_stud_m +
              edu1849_pub_ele_stud_f +
              edu1849_pub_mim_stud_m +
              edu1849_pub_mif_stud_f +
              edu1849_pub_high_stud_m +
              edu1849_pub_pgy_stud_m +
              edu1849_pub_gym_stud_m +
              edu1849_pub_sem_stud) %>%
...
# Read in Servants occupation in 1849

serv1849 <- read.csv("../data/Data Proxy Industrializtaion/Occupation/Servants 1849_occ_serv Kopie.csv")

serv1849length <- dim(serv1849)[2]
serv1849lengthonlydata <- select(serv1849, !c(kreiskey1849, county, rb))

for(i in 1:dim(serv1849lengthonlydata)[1]) {
  serv1849$servs[i] <- sum(serv1849lengthonlydata[i,])
}
